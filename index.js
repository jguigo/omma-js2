...
btnEnviar.onclick = (evento) => {
  ...
  let inputVegano = document.querySelector('input[name="vegano"]:checked'); //estuda essa merda depois

  let novaReceita ={
    id: listaDeReceitas.length,
    titulo: inputTitulo.value,
    dificuldade: inputDificuldade.value,
    ingredientes: inputIngredientes.value.split(','), //faz com separe os itens vai funcionar como click
